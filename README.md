...
| `test/e2e/`                       | Browser behavior: nav modal, recommendation modal, first paint, DevTools issues, reading progress, table wrapping, YouTube facade, keyboard paths, axe at WCAG 2.1 AA, console and network errors | Yes           |
