...
export function initNavModal() {
	...
	// The dialog fills the viewport, so a click landing on the element itself
	// rather than a descendant is a click on the empty area around the menu.
	modal.addEventListener('click', event => {
		if (event.target === modal) closeNavModal()
		return undefined
	})
