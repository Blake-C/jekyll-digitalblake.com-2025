...
layout: case-study
featured: true
permalink: /case-studies/seismic/
title: Seismic
...
Security hardening was a significant part of the WordPress platform work. We used WordFence to restrict wp-login and API access to corporate VPN and approved user IPs, and Melapress Login Security to enforce two-factor authentication across all admin accounts. Melapress WP Activity Log gave us a full audit trail: every login, page view, and content change was recorded, with the ability to roll back anything that had been modified. This gave the team complete visibility into site activity and a clear remediation path when anything looked out of place.
